...
#else
out lowp    vec4    colorSpecular;
#endif

uniform highp mat4      uMVMatrix;
uniform highp mat4      uPMatrix[4];
...
void main(void)
{
    ...
    //gl_Position = uMVMatrix * uPMatrix[0] * p;
    highp mat4 mvp = uPMatrix[gl_ViewID_OVR] * uMVMatrix;
    gl_Position = mvp * p;
    //gl_Position = uPMatrix[0] * p;
    //gl_Position = uPMatrix[gl_ViewID_OVR] * p;
